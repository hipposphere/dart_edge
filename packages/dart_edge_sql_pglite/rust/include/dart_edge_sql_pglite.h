...
typedef void (*dart_edge_sql_pglite_close_pool_callback)(int64_t handle);
...
bool dart_edge_sql_pglite_bind_pool(
    int64_t handle,
    int64_t pool_handle,
    dart_edge_sql_pglite_close_pool_callback close_pool);
bool dart_edge_sql_pglite_close(int64_t handle);
void dart_edge_sql_pglite_close_finalizer(void *handle);
