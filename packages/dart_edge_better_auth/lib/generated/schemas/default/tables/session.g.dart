...
final class BetterAuthSessionRow implements JsonEncodable {
  const BetterAuthSessionRow({
    required this.id,
  ...
  factory BetterAuthSessionRow.fromSqlRow(SqlRow row, {String prefix = ''}) =>
  ...
  factory BetterAuthSessionRow.fromColumns(
    Map<String, Object?> columns, {
    String prefix = '',
  }) => BetterAuthSessionRow.fromSqlRow(SqlRow(columns), prefix: prefix);

  factory BetterAuthSessionRow.decode(Object? value) =>
      BetterAuthSessionRow.fromJson(readJsonObject(value));

  factory BetterAuthSessionRow.fromJson(
  ...
  static const schemaId = 'BetterAuthSessionRow';
  ...
  @override
  String toString() =>
      'BetterAuthSessionRow(id: $id, expiresAt: $expiresAt, token: $token, createdAt: $createdAt, updatedAt: $updatedAt, ipAddress: $ipAddress, userAgent: $userAgent, userId: $userId, impersonatedBy: $impersonatedBy)';
}

final class BetterAuthSessionInsert implements JsonEncodable {
  const BetterAuthSessionInsert({
  ...
  factory BetterAuthSessionInsert.decode(Object? value) =>
      BetterAuthSessionInsert.fromJson(readJsonObject(value));

  factory BetterAuthSessionInsert.fromJson(
    Map<String, Object?> json,
  ...
  static const schemaId = 'BetterAuthSessionInsert';
  ...
  BetterAuthSessionInsert copyWith({
    SqlValue<String>? id,
    DateTime? expiresAt,
    String? token,
    DateTime? createdAt,
    ...
    return BetterAuthSessionInsert(
      id: id ?? this.id,
      expiresAt: expiresAt ?? this.expiresAt,
      token: token ?? this.token,
      createdAt: createdAt ?? this.createdAt,
  ...
  @override
  String toString() =>
      'BetterAuthSessionInsert(id: $id, expiresAt: $expiresAt, token: $token, createdAt: $createdAt, updatedAt: $updatedAt, ipAddress: $ipAddress, userAgent: $userAgent, userId: $userId, impersonatedBy: $impersonatedBy)';
}

final class BetterAuthSessionUpdate implements JsonEncodable {
  const BetterAuthSessionUpdate({
    this.id = const SqlValue.absent(),
  ...
  factory BetterAuthSessionUpdate.decode(Object? value) =>
      BetterAuthSessionUpdate.fromJson(readJsonObject(value));

  factory BetterAuthSessionUpdate.fromJson(
    Map<String, Object?> json,
  ) => BetterAuthSessionUpdate(
    id: json.containsKey('id')
        ? SqlValue<String>((json['id'] as String))
        : const SqlValue.absent(),
  ...
  static const schemaId = 'BetterAuthSessionUpdate';
  ...
  BetterAuthSessionUpdate copyWith({
    SqlValue<String>? id,
    ...
    return BetterAuthSessionUpdate(
      id: id ?? this.id,
      expiresAt: expiresAt ?? this.expiresAt,
      token: token ?? this.token,
      createdAt: createdAt ?? this.createdAt,
  ...
  @override
  String toString() =>
      'BetterAuthSessionUpdate(id: $id, expiresAt: $expiresAt, token: $token, createdAt: $createdAt, updatedAt: $updatedAt, ipAddress: $ipAddress, userAgent: $userAgent, userId: $userId, impersonatedBy: $impersonatedBy)';
}

final class BetterAuthSessionsTable
    extends
        SqlTable<
          BetterAuthSessionRow,
          BetterAuthSessionInsert,
          BetterAuthSessionUpdate
        > {
  const BetterAuthSessionsTable._() : schema = null;

  const BetterAuthSessionsTable.withSchema(this.schema);

  @override
  final String? schema;

  static const table = BetterAuthSessionsTable._();
  ...
  @override
  BetterAuthSessionRow mapRow(SqlRow row, {String prefix = ''}) =>
      BetterAuthSessionRow.fromSqlRow(row, prefix: prefix);

  @override
  Map<String, Object?> encodeInsert(BetterAuthSessionInsert value) =>
      value.toColumns();

  @override
  Map<String, Object?> encodeUpdate(BetterAuthSessionUpdate value) =>
      value.toColumns();
}

extension BetterAuthSessionsTableColumns on BetterAuthSessionsTable {
