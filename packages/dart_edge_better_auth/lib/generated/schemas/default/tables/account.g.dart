...
final class BetterAuthAccountRow implements JsonEncodable {
  const BetterAuthAccountRow({
    required this.id,
  ...
  factory BetterAuthAccountRow.fromSqlRow(SqlRow row, {String prefix = ''}) =>
  ...
  factory BetterAuthAccountRow.fromColumns(
    Map<String, Object?> columns, {
    String prefix = '',
  }) => BetterAuthAccountRow.fromSqlRow(SqlRow(columns), prefix: prefix);

  factory BetterAuthAccountRow.decode(Object? value) =>
      BetterAuthAccountRow.fromJson(readJsonObject(value));

  factory BetterAuthAccountRow.fromJson(Map<String, Object?> json) =>
      BetterAuthAccountRow(
  ...
  static const schemaId = 'BetterAuthAccountRow';
...
final class BetterAuthAccountInsert implements JsonEncodable {
  ...
  factory BetterAuthAccountInsert.decode(Object? value) =>
      BetterAuthAccountInsert.fromJson(readJsonObject(value));

  factory BetterAuthAccountInsert.fromJson(Map<String, Object?> json) =>
  ...
  static const schemaId = 'BetterAuthAccountInsert';
  ...
  BetterAuthAccountInsert copyWith({
    SqlValue<String>? id,
    String? accountId,
    String? providerId,
    String? userId,
    ...
    return BetterAuthAccountInsert(
      id: id ?? this.id,
      accountId: accountId ?? this.accountId,
      providerId: providerId ?? this.providerId,
      userId: userId ?? this.userId,
  ...
  @override
  String toString() =>
      'BetterAuthAccountInsert(id: $id, accountId: $accountId, providerId: $providerId, userId: $userId, accessToken: $accessToken, refreshToken: $refreshToken, idToken: $idToken, accessTokenExpiresAt: $accessTokenExpiresAt, refreshTokenExpiresAt: $refreshTokenExpiresAt, scope: $scope, password: $password, createdAt: $createdAt, updatedAt: $updatedAt)';
}

final class BetterAuthAccountUpdate implements JsonEncodable {
  const BetterAuthAccountUpdate({
    this.id = const SqlValue.absent(),
  ...
  factory BetterAuthAccountUpdate.decode(Object? value) =>
      BetterAuthAccountUpdate.fromJson(readJsonObject(value));

  factory BetterAuthAccountUpdate.fromJson(Map<String, Object?> json) =>
      BetterAuthAccountUpdate(
        id: json.containsKey('id')
            ? SqlValue<String>((json['id'] as String))
            : const SqlValue.absent(),
  ...
  static const schemaId = 'BetterAuthAccountUpdate';
  ...
  BetterAuthAccountUpdate copyWith({
    SqlValue<String>? id,
    ...
    return BetterAuthAccountUpdate(
      id: id ?? this.id,
      accountId: accountId ?? this.accountId,
      providerId: providerId ?? this.providerId,
      userId: userId ?? this.userId,
  ...
  @override
  String toString() =>
      'BetterAuthAccountUpdate(id: $id, accountId: $accountId, providerId: $providerId, userId: $userId, accessToken: $accessToken, refreshToken: $refreshToken, idToken: $idToken, accessTokenExpiresAt: $accessTokenExpiresAt, refreshTokenExpiresAt: $refreshTokenExpiresAt, scope: $scope, password: $password, createdAt: $createdAt, updatedAt: $updatedAt)';
}

final class BetterAuthAccountsTable
    extends
        SqlTable<
          BetterAuthAccountRow,
          BetterAuthAccountInsert,
          BetterAuthAccountUpdate
        > {
  const BetterAuthAccountsTable._() : schema = null;

  const BetterAuthAccountsTable.withSchema(this.schema);

  @override
  final String? schema;

  static const table = BetterAuthAccountsTable._();
  ...
  @override
  BetterAuthAccountRow mapRow(SqlRow row, {String prefix = ''}) =>
      BetterAuthAccountRow.fromSqlRow(row, prefix: prefix);

  @override
  Map<String, Object?> encodeInsert(BetterAuthAccountInsert value) =>
      value.toColumns();

  @override
  Map<String, Object?> encodeUpdate(BetterAuthAccountUpdate value) =>
      value.toColumns();
}

extension BetterAuthAccountsTableColumns on BetterAuthAccountsTable {
