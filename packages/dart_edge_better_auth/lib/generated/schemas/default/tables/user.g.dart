...
final class BetterAuthUserRow implements JsonEncodable {
  const BetterAuthUserRow({
    required this.id,
    required this.name,
    required this.email,
  ...
  factory BetterAuthUserRow.fromSqlRow(SqlRow row, {String prefix = ''}) =>
      BetterAuthUserRow(
  ...
  factory BetterAuthUserRow.fromColumns(
    Map<String, Object?> columns, {
    String prefix = '',
  }) => BetterAuthUserRow.fromSqlRow(SqlRow(columns), prefix: prefix);

  factory BetterAuthUserRow.decode(Object? value) =>
      BetterAuthUserRow.fromJson(readJsonObject(value));

  factory BetterAuthUserRow.fromJson(Map<String, Object?> json) =>
      BetterAuthUserRow(
  ...
  static const schemaId = 'BetterAuthUserRow';
  ...
  @override
  String toString() =>
      'BetterAuthUserRow(id: $id, name: $name, email: $email, emailVerified: $emailVerified, image: $image, createdAt: $createdAt, updatedAt: $updatedAt, role: $role, banned: $banned, banReason: $banReason, banExpires: $banExpires, phoneNumber: $phoneNumber, phoneNumberVerified: $phoneNumberVerified)';
}

final class BetterAuthUserInsert implements JsonEncodable {
  const BetterAuthUserInsert({
  ...
  factory BetterAuthUserInsert.decode(Object? value) =>
      BetterAuthUserInsert.fromJson(readJsonObject(value));

  factory BetterAuthUserInsert.fromJson(Map<String, Object?> json) =>
  ...
  static const schemaId = 'BetterAuthUserInsert';
  ...
  @override
  String toString() =>
      'BetterAuthUserInsert(id: $id, name: $name, email: $email, emailVerified: $emailVerified, image: $image, createdAt: $createdAt, updatedAt: $updatedAt, role: $role, banned: $banned, banReason: $banReason, banExpires: $banExpires, phoneNumber: $phoneNumber, phoneNumberVerified: $phoneNumberVerified)';
}

final class BetterAuthUserUpdate implements JsonEncodable {
  const BetterAuthUserUpdate({
    this.id = const SqlValue.absent(),
  ...
  factory BetterAuthUserUpdate.decode(Object? value) =>
      BetterAuthUserUpdate.fromJson(readJsonObject(value));

  factory BetterAuthUserUpdate.fromJson(Map<String, Object?> json) =>
      BetterAuthUserUpdate(
        id: json.containsKey('id')
            ? SqlValue<String>((json['id'] as String))
            : const SqlValue.absent(),
  ...
  static const schemaId = 'BetterAuthUserUpdate';
  ...
  @override
  String toString() =>
      'BetterAuthUserUpdate(id: $id, name: $name, email: $email, emailVerified: $emailVerified, image: $image, createdAt: $createdAt, updatedAt: $updatedAt, role: $role, banned: $banned, banReason: $banReason, banExpires: $banExpires, phoneNumber: $phoneNumber, phoneNumberVerified: $phoneNumberVerified)';
}

final class BetterAuthUsersTable
    extends
        SqlTable<
          BetterAuthUserRow,
          BetterAuthUserInsert,
          BetterAuthUserUpdate
        > {
  const BetterAuthUsersTable._() : schema = null;

  const BetterAuthUsersTable.withSchema(this.schema);

  @override
  final String? schema;

  static const table = BetterAuthUsersTable._();
  ...
  @override
  BetterAuthUserRow mapRow(SqlRow row, {String prefix = ''}) =>
      BetterAuthUserRow.fromSqlRow(row, prefix: prefix);

  @override
  Map<String, Object?> encodeInsert(BetterAuthUserInsert value) =>
      value.toColumns();

  @override
  Map<String, Object?> encodeUpdate(BetterAuthUserUpdate value) =>
      value.toColumns();
}

extension BetterAuthUsersTableColumns on BetterAuthUsersTable {
