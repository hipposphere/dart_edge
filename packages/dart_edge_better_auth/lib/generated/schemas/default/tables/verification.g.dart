...
final class BetterAuthVerificationRow implements JsonEncodable {
  const BetterAuthVerificationRow({
    required this.id,
  ...
  factory BetterAuthVerificationRow.fromSqlRow(
    SqlRow row, {
    String prefix = '',
  }) => BetterAuthVerificationRow(
  ...
  factory BetterAuthVerificationRow.fromColumns(
    Map<String, Object?> columns, {
    String prefix = '',
  }) => BetterAuthVerificationRow.fromSqlRow(SqlRow(columns), prefix: prefix);

  factory BetterAuthVerificationRow.decode(Object? value) =>
      BetterAuthVerificationRow.fromJson(readJsonObject(value));

  factory BetterAuthVerificationRow.fromJson(Map<String, Object?> json) =>
      BetterAuthVerificationRow(
  ...
  static const schemaId = 'BetterAuthVerificationRow';
  ...
  BetterAuthVerificationRow copyWith({
    String? id,
    String? identifier,
    String? value,
    DateTime? expiresAt,
    ...
    return BetterAuthVerificationRow(
      id: id ?? this.id,
  ...
  @override
  String toString() =>
      'BetterAuthVerificationRow(id: $id, identifier: $identifier, value: $value, expiresAt: $expiresAt, createdAt: $createdAt, updatedAt: $updatedAt)';
}

final class BetterAuthVerificationInsert implements JsonEncodable {
  const BetterAuthVerificationInsert({
  ...
  factory BetterAuthVerificationInsert.decode(Object? value) =>
      BetterAuthVerificationInsert.fromJson(readJsonObject(value));

  factory BetterAuthVerificationInsert.fromJson(Map<String, Object?> json) =>
      BetterAuthVerificationInsert(
  ...
  static const schemaId = 'BetterAuthVerificationInsert';
  ...
  BetterAuthVerificationInsert copyWith({
    SqlValue<String>? id,
    String? identifier,
    String? value,
    DateTime? expiresAt,
    ...
    return BetterAuthVerificationInsert(
      id: id ?? this.id,
      identifier: identifier ?? this.identifier,
      value: value ?? this.value,
      expiresAt: expiresAt ?? this.expiresAt,
  ...
  @override
  String toString() =>
      'BetterAuthVerificationInsert(id: $id, identifier: $identifier, value: $value, expiresAt: $expiresAt, createdAt: $createdAt, updatedAt: $updatedAt)';
}

final class BetterAuthVerificationUpdate implements JsonEncodable {
  const BetterAuthVerificationUpdate({
    this.id = const SqlValue.absent(),
  ...
  factory BetterAuthVerificationUpdate.decode(Object? value) =>
      BetterAuthVerificationUpdate.fromJson(readJsonObject(value));

  factory BetterAuthVerificationUpdate.fromJson(Map<String, Object?> json) =>
      BetterAuthVerificationUpdate(
        id: json.containsKey('id')
            ? SqlValue<String>((json['id'] as String))
            : const SqlValue.absent(),
  ...
  static const schemaId = 'BetterAuthVerificationUpdate';
  ...
  BetterAuthVerificationUpdate copyWith({
    SqlValue<String>? id,
    ...
    return BetterAuthVerificationUpdate(
      id: id ?? this.id,
      identifier: identifier ?? this.identifier,
      value: value ?? this.value,
      expiresAt: expiresAt ?? this.expiresAt,
  ...
  @override
  String toString() =>
      'BetterAuthVerificationUpdate(id: $id, identifier: $identifier, value: $value, expiresAt: $expiresAt, createdAt: $createdAt, updatedAt: $updatedAt)';
}

final class BetterAuthVerificationsTable
    extends
        SqlTable<
          BetterAuthVerificationRow,
          BetterAuthVerificationInsert,
          BetterAuthVerificationUpdate
        > {
  const BetterAuthVerificationsTable._() : schema = null;

  const BetterAuthVerificationsTable.withSchema(this.schema);

  @override
  final String? schema;

  static const table = BetterAuthVerificationsTable._();
  ...
  @override
  BetterAuthVerificationRow mapRow(SqlRow row, {String prefix = ''}) =>
      BetterAuthVerificationRow.fromSqlRow(row, prefix: prefix);

  @override
  Map<String, Object?> encodeInsert(BetterAuthVerificationInsert value) =>
      value.toColumns();

  @override
  Map<String, Object?> encodeUpdate(BetterAuthVerificationUpdate value) =>
      value.toColumns();
}

extension BetterAuthVerificationsTableColumns on BetterAuthVerificationsTable {
