...
Future<void> main() async {
  ...
  final emission = emitDartSchema(
    database,
    databaseClassName: 'BetterAuthTables',
    naming: DartSchemaNaming(modelNameBuilder: _betterAuthModelName),
...
String _betterAuthModelName(DartSchemaModelNameContext context) {
  final tablePrefix = switch (context.tableName) {
    'user' => 'BetterAuthUser',
    'session' => 'BetterAuthSession',
    'account' => 'BetterAuthAccount',
    'verification' => 'BetterAuthVerification',
    'passkey' => 'BetterAuthPasskey',
