...
ScenarioLoadResult _parseOhaJson(Map<String, Object?> json) {
  ...
  final successfulOperations = _sumDistribution(statusCodeDistribution);
  final errorCount = _sumDistribution(errorDistribution);

  return ScenarioLoadResult(
    operations: successfulOperations,
    errors: errorCount,
    operationsPerSecond: _readDouble(summary, 'requestsPerSec') ?? 0,
